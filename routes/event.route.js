...
/** create route to find event using method "GET" and define parameter for "keyword" */
...
/** create route to delete event using method "DELETE and define parameter for "id" */
